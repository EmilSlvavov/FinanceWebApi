...
/**
 * Page for advanced expense searching and filtering
 */
public class ExpenseSearchPage {
    ...
    public static void show(ExpenseService expenseService) {
        ...
        switch (choice) {
            case "1":
                searchByCategory(expenseService);
                break;
            case "2":
                searchByAmountRange(expenseService);
                break;
            case "3":
                searchByAll(expenseService);
                break;
            case "4":
    ...
    private static void displaySearchResults(PagedResponse<ExpenseResponse> response, int currentPage, ExpenseService expenseService, 
                                            String category, Double minAmount, Double maxAmount) {
        while (true) {
            ConsoleUI.clearScreen();
